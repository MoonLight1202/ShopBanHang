...
public class PhoneFragment extends Fragment {
    ...
    private ArrayList<Product> productArrayList,PhoneArrayList;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < productArrayList.size(); i++) {
            if(productArrayList.get( i ).getCatId()==1){
                PhoneArrayList.add( productArrayList.get( i ) );
            }
        }
        productAdapter = new ProductAdapter(PhoneArrayList,rootView.getContext());
